...
public class User {
	...
	public User(int id, String name, String lastname, String password, String description, int rating, String title,
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", lastname=" + lastname + ", password=" + password
				+ ", description=" + description + ", rating=" + rating + ", title=" + title + ", phone=" + phone
				+ ", web=" + web + ", linkedin=" + linkedin + ", git=" + git + ", avatar=" + avatar + ", role=" + role
				+ "]";
	}
}